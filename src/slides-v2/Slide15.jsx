...
\left(A_m - \sum_{r=1}^{N_r}\beta_r^2 M_t^{-1}\right)C^{n+1} &=
\left(B_m + \sum_{r=1}^{N_r}\beta_r^2 M_t^{-1}\right)C^n + F_m \\
&\quad + \sum_{r=1}^{N_r}\beta_r\!\left(I + M_r^{-1}M_r^-\right)S_r^n
\end{aligned}`;

const eq18 = String.raw`\mathcal{P}\,C^{n+1} = \mathcal{R}\,C^n + \sum_r \mathcal{Q}_r S_r^n + F`;
