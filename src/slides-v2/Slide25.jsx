...
const EscalarizacionSVG = () => (
    <svg viewBox="0 0 900 750"
        ...
        <text x="775" y="705" style={{ fill: 'var(--sl-accent)', fontSize: '18px', fontStyle: 'italic' }}>Jₑ</text>
        ...
        <text x="480" y="394" textAnchor="middle"
              style={{ fill: '#ff5555', fontSize: '18px' }}>Rectas de nivel</text>

        {/* ── Punto óptimo ── */}
        <circle cx="374" cy="580" r="5" style={{ fill: 'var(--sl-accent)' }} />
        <text x="362" y="600" textAnchor="middle"
              style={{ fill: 'var(--sl-text)', fontSize: '20px' }}>solución</text>
    </svg>
);
